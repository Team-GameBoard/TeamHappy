	...
	<div style="border: 1px solid black; width: 30vw; min-width: 1040px; height: 70vh; margin: 0 auto; margin-top: 5rem; ">
		...
		<div style="border: 1px solid black; width: 60%; height: 60%; margin: 0 auto; margin-top: 1rem; display: flex; align-items: center;">
			<div style="width: 500px; height: 300px; margin: 0 auto; display: flex;">
				<div style="width: 40%; height: 100%; text-align: right;">
					<h3 style="margin: 1.75rem 0.5rem 1.75rem 0">아이디 :</h2>
					<h3 style="margin: 1.75rem 0.5rem 1.75rem 0">패스워드 :</h2>
					<h3 style="margin: 1.75rem 0.5rem 1.75rem 0">나이 :</h2>
					<h3 style="margin: 1.75rem 0.5rem 1.75rem 0">게시판 등급 :</h2>
				</div>
				<div style="width: 60%; height: 100%; text-align: center;">
					<h3 style="margin: 1.75rem 0">${requestScope.userInfo.userId}</h3>
					<h3 style="margin: 1.75rem 0">********</h3>
					<h3 style="margin: 1.75rem 0">${requestScope.userInfo.userAge}</h3>
					<h3 style="margin: 1.75rem 0">${requestScope.userInfo.userGrade}</h3>
				</div>
			</div>
		...
		<div style="height: 10%; width: 150px; margin-top: 1rem; margin-right: 13rem; float: right;">
			<form action="board" method="post">
				...
				<input type="hidden" name="count" value="update">
				<button class="btn btn-lg btn-primary btn-block text-uppercase"
					style="float: right;" type="submit">수정하기</button>
			</form>
		</div>
	</div>
